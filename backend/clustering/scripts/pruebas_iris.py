...
def ejecutarClusteringConSemilla(datosOriginales, etiquetasOriginales, semilla):
    ...
    metricasInternas = ultimoResultado['metricasInternas']
    metricasExternas = ultimoResultado['metricasExternas']
    ...
    return {
        ...
        'tamaniosActuales': clustering.tamaniosActuales.copy(),
        'tamaniosMaximos': clustering.tamaniosMaximos.copy(),
...
def main():
    ...
    resultadosCluORT, resultadosKMeans = ejecutarExperimentos(datosOriginales, etiquetasOriginales, numSemillas=4, semillaInicial=0)
